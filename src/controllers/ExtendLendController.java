...
public class ExtendLendController {
    ...
    private ObservableList<LentBook> getLentBookList() {
        ...
        /*LentBook LntBK1 = new LentBook(1248,new Book(123, "book1", "fadi", "1", 6, "action", "anananana", 1, "annon", "shelf", 12, "regular", 1), null, LocalDate.now(), LocalDate.now().plusWeeks(2), false);
        LentBook LntBK2 = new LentBook(123448,new Book(1233, "book2", "adam", "1", 6, "action", "anananana", 1, "annon", "shelf", 12, "regular", 1), null, LocalDate.now(), LocalDate.now().plusWeeks(2), false);
        ArrayList<LentBook> arr = new ArrayList<>(Arrays.asList(LntBK1, LntBK2));*/
        ...
        ObservableList<LentBook> list = FXCollections.observableArrayList(/*arr*/);//Jigsaw commented that
